...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "soserver" do |soserver|
    soserver.vm.box = "ubuntu/trusty64"
  ...
  config.vm.define "sosensor" do |sosensor|
    sosensor.vm.box = "ubuntu/trusty64"
...
#    sosensor.vm.box = "ubuntu/trusty64"
#    sosensor.vm.hostname = "sosensor"
#    sosensor.vm.network "private_network", ip: "192.168.50.30", virtualbox__intnet: true
#    config.vm.provider :virtualbox do |vb|
#      vb.customize ["modifyvm", :id, "--memory", "2028"]
#    end
#    sosensor.vm.provision :chef_zero do |chef|
#      chef.roles_path = "~/chef-local/roles"
#      chef.cookbooks_path = ["~/chef-local/site-cookbooks", "~/chef-local/cookbooks"]
#      chef.nodes_path = "~/chef-local/nodes"
#      chef.run_list = ['recipe[seconion::sensor]']
#    end
#  end
