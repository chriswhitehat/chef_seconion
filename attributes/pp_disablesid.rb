...
# Example
#default[:seconion][:sensor][:pulledpork][:disablesid][:global]['pcre:ET CNC'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:disablesid]['sensor_group_name']['1:220-1:3264'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:disablesid]['sensorname']['1:1034,1:9837,1:1270,1:3390,1:710,1:1249,3:13010'] = true
