...
# Example
#default[:seconion][:sensor][:pulledpork][:dropsid][:global]['pcre:ET CNC'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:dropsid]['sosensor']['pcre:MS(0[7-9]|10)-\d+'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:dropsid]['sensorname']['1:1034,1:9837,1:1270,1:3390,1:710,1:1249,3:13010'] = true
