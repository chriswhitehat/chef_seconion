...
# Example
#default[:seconion][:sensor][:pulledpork][:enablesid][:regional]['1:220-1:3264'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:enablesid]['sensor_group_name']['1:220-1:3264'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:enablesid]['hostname.example.com']['pcre:MS(0[7-9]|10)-\d+'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:enablesid]['sensorname']['1:1034,1:9837,1:1270,1:3390,1:710,1:1249,3:13010'] = true
