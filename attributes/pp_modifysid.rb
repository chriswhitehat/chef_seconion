...
# Example
#default[:seconion][:sensor][:pulledpork][:modifysid][:regional]['1:220-1:3264'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:modifysid]['sensor_group_name']['1:220-1:3264'] = true
...
# Example
#default[:seconion][:sensor][:pulledpork][:modifysid]['hostname.example.com']['pcre:MS(0[7-9]|10)-\d+'] = true
