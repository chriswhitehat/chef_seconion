...
# Example
#default[:seconion][:sensor][:threshold][:global]['suppress gen_id 1, sig_id 1852'] = true
...
# Example
#default[:seconion][:sensor][:threshold][:regional]['gen_id 1, sig_id 1852, track by_src, ip 10.1.1.54'] = true
...
# Example
#default[:seconion][:sensor][:threshold]['hostname.example.com']['gen_id 1, sig_id 1852, track by_dst, ip 10.1.1.0/24'] = true
...
# Example
#default[:seconion][:sensor][:threshold]['sensorname']['suppress gen_id 1, sig_id 1852'] = true
